...
from .subagents.thumbnail_analyzer.agent import thumbnail_analyzer_agent
...
thumbnail_agent = Agent(
    ...
    model=GEMINI_MODEL,
    description="A manager agent that dictates or manages the entire process of clonning the style of a YouTube thumbnails from the channel",
    sub_agents=[generate_image_agent,thumbnail_scraper_agent, thumbnail_analyzer_agent, prompt_generator],
    instruction="""
